...
public class QPostTag extends EntityPathBase<PostTag> {
    ...
    private static final long serialVersionUID = -902561975L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPostTag postTag = new QPostTag("postTag");

    public final StringPath actualTagName = createString("actualTagName");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final QPost post;

    public final QTags tag;
    ...
    public QPostTag(Class<? extends PostTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tag = inits.isInitialized("tag") ? new QTags(forProperty("tag")) : null;
    }
